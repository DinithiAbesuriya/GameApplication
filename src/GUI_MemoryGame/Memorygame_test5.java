 ...
 * @author dinithi
 */
public class Memorygame_test5 extends javax.swing.JFrame {
      ...
      String imagereturn=null;
        try {
          ...
          getgame();
            ...
            Logger.getLogger(Memorygame_test5.class.getName()).log(Level.SEVERE, null, ex);
        }
         return imagereturn;
 }
  ...
  public JButton disablebutton1()
 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Memorygame_test5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Memorygame_test5().setVisible(true);
            }
        });
    }
