 ...
 * @author dinithi
 */
public class Memorygame_test1 extends javax.swing.JFrame {
...
//Memory m=new Memory(id[0], image[0], matchid[0], matchingtitle1[0], matchingtitle1[0]);
 ...
 public String getmatching(int id)
 {
      String imagereturn=null;
        try {
            ...
            Logger.getLogger(Memorygame_test1.class.getName()).log(Level.SEVERE, null, ex);
        }
         return imagereturn;
 }
  ...
  public JButton disablebutton1()
 {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("/Users/dinithi/Desktop/3rd Year 1st Semester/CIS/Assignment/gamepictures/exitmemory.png")); // NOI18N
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 690, 220, 80));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Memorygame_test1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Memorygame_test1().setVisible(true);
            }
        });
    }
