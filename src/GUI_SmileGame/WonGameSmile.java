...
public class WonGameSmile extends javax.swing.JFrame {
CoinsEarnedGUI ce;
CoinsEarned coins;
int coins_value;
String user;
...
DBFetchDataSmileGame data;
    ...
    try {
        ...
        ce.gameplayed="SmileGame";
        ce.username=user;
    } catch (SQLException ex) {
        Logger.getLogger(WonGameSmile.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WonGameSmile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       public void run() {
               ...
               new WonGameSmile().setVisible(true);
            }
        });
    }
