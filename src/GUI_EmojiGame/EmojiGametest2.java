...
public class EmojiGametest2 extends javax.swing.JFrame {
    Emoji EmojiList[];
    int index;
    int randomfirst;
    int nextrandom;
       ...
       // int levelrandom = levelrandom();
        JOptionPane.showMessageDialog(rootPane, "currentlevel: "+data.getcurrentlevel(username));
         ...
         JOptionPane.showMessageDialog(rootPane, "currentlevel: "+data.getcurrentlevel(username).next());
            ...
            Logger.getLogger(EmojiGametest2.class.getName()).log(Level.SEVERE, null, ex);
        }
...
JOptionPane.showMessageDialog(rootPane, "started:"+countofgames);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmojiGametest2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmojiGametest2().setVisible(true);
            }
        });
    }
